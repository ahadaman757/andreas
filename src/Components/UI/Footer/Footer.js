...
function Footer() {
    return (
        <div className="container-fluid   ps-md-0 bg-white" style={{ position: 'relative' }}>
            <div className="row">
                    ...
                    <div className="container">
                        <div className="row py-md-5">
                            <div className="col-md-3 ">
                                <Logo />
                                <p>Lorem ipsum dolor, sit amet consectetur adipisicing elit. Nulla quisquam, molestias sunt voluptatum, quibusdam.</p>
                            </div>
            ...
            <div className="row text-center text-black py-2" style={{ borderTop: '1px solid rgba(233, 233, 233, 0.24)' }}>
                <p className='mb-0'>
                    © 2022 yourdomain.com
                </p>
            </div>
