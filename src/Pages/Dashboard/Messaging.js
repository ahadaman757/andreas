...
function Messaging() {
  ...
  useEffect(() => {
    axios.post(`https://3.14.27.53:3001/chats/chats_by_agent`, { id: authState.LoggedUserData.id, client_status: authState.LoggedUserData.account_type, company_url: authState.LoggedUserData.company_url }).then(response => {
      setchatList((pre) => {
  ...
  const getAllList = () => {
    axios.post(`https://3.14.27.53:3001/chats/chats_by_agent`, { id: authState.LoggedUserData.id, client_status: authState.LoggedUserData.account_type }).then(response => {
      setchatList((pre) => {
