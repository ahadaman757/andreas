...
const Subscriptions = () => {
  ...
  const cancelAccount = () => {
    ...
    axios
      .post(`https://3.14.27.53:3001/userCustomerId`, {
      ...
      .then((r) => {
        ...
        axios
          .post(`https://3.14.27.53:3001/getSubList`, {
          ...
          .then((response) => {
            ...
            axios
              ...
              .then((response) =>
                axios
                  .post(`https://3.14.27.53:3001/removeCustomerId`, {
  ...
  useEffect(() => {
    // GET CURRENT PLAN
    axios
      .get(`https://3.14.27.53:3001/currentplan/${authState.LoggedUserData.id}`)
      .then((response) => {
          ...
          <div className="card">
            <div className="card-body">
              ...
              {freeActivate == "0" ? (
                ...
                <form
                  action="https://3.14.27.53:3001/create-checkout-session1"
                  method="POST"
                >
